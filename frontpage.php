...
get_header(); ?>
    ...
    <div class="video-overlay">
        <h1 class="text-white m-auto text-center tracking-wider text-4xl md:text-6xl"><?php the_field('display_title') ?></h1>
            ...
            <div class="grid grid-cols-12">
                <div class="col-span-12">
                    <div class="text-left px-2 mb-1">
                        <h2 class="text-2xl pb-3 md:pr-5 inline-block"><?php the_field('primary_cta_text') ?></h2>
