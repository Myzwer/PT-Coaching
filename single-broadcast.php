...
?>
    ...
    <div class="bg-gray pb-5 pt-12">
        <div class="md:w-3/4 mx-auto grid grid-cols-12 p-2">
            ...
            <div class="col-span-12 lg:col-span-10 p-5 bg-gray-light shadow-lg ">
...
?>
    ...
    <div class="bg-gray pb-5">
        <div class="md:w-3/4 mx-auto grid grid-cols-12 p-2">
            ...
            <div class="col-span-12 lg:col-span-10 p-5 bg-gray-light text-center shadow-lg ">
                <a href="">
                    <?php next_post_link('%link', '<button class="uppercase inline-block rounded-md mt-3 py-3 px-6 text-white bg-gray-dark hover:bg-gray-darkest transition duration-300">Next' . $formatNameSingle . '</button>', true, "", 'format'); ?>
                </a>
